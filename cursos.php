						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>
									...
									¿Hay inscripciones abiertas todo el año? </a>
								</p>
								...
								<p>
									...
									¿Cuántas personas son por grupo? </a>
								</p>
								...
								<p>
									...
									¿Aplican examen de colocación? </a>
								</p>
								...
								<p>
									...
									¿Manejan grupos de preescolar? </a>
								</p>
								...
								<p>
									...
									¿Aplican algún descuento por hermanos inscritos? </a>
								</p>
								...
								<p>
									...
									¿Ofrecen asesorías individuales o cursos personalizados? </a>
								</p>
								...
								<p>
									...
									¿Imparten cursos empresariales? </a>
								</p>
								...
								<p>
									...
									¿Se puede presentar con ustedes el examen TOEFL? </a>
								</p>
								...
								<p>
									<div class="b1 btn btn-block btn-outline-success no-border" data-toggle="collapse" href="#collapse11" role="button" aria-expanded="false" aria-controls="collapseExample">
										 ¿Cuánto tiempo considera que se necesite para que un adulto pueda llegar a ser bilingüe?
									</div>
								</p>
								...
								<p>
									...
									Ponte en contacto con Smart English Institute aqui </a>
								</p>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-outline-success" data-dismiss="modal">Cerrar</button>
