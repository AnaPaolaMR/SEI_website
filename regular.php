...
<body>
				...
				<div class="col-sm-12 col-md-3 align-self-center text-center">
					<div class="dropdown text text-menu">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownmenu1">
							...
							<a class="dropdown-item" href="club.html">Club de conversacion</a>
	...
	<footer>
		...
		<a href="cursos.html" class="btn btn-lg btn-outline-success text-center justify-center text-volver">
			volver
		</a>
	</footer>
